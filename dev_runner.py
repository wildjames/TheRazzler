...
class ChangeHandler(FileSystemEventHandler):
    ...
    def __init__(self, command: List[str], ignores: Optional[List[str]] = None):
...
def start_monitoring(path, command: List[str], ignores: Optional[List[str]] = None):
...
if __name__ == "__main__":
    ...
    ignores = ["venv/*", ".git*", "*__pycache__*", "data/*", "*.log", "*.pid"]
